<template>
  <div class="flex justify-center items-center min-h-[70vh]">
    <div class="organic-box p-10 max-w-md w-full bg-white shadow-xl relative z-10">
      <div class="flex flex-col items-center mb-6">
        <div class="w-16 h-16 bg-[#0070BB] rounded-full flex items-center justify-center text-white mb-4">
          👤
        </div>
      ...
      <form @submit.prevent="handleLogin" class="space-y-5">
        ...
        <div>
          <label class="block font-bold mb-2 ml-2 text-sm uppercase text-gray-600">Jméno</label>
          <input 
        ...
        <div>
          <label class="block font-bold mb-2 ml-2 text-sm uppercase text-gray-600">Heslo</label>
          <input 
      ...
      <p class="text-center mt-6 text-sm text-gray-400">Demo: lecturer / TdA26!</p>
    </div>
  </div>
</template>
...
const handleLogin = () => {
  ...
  // Demo credentials
  if (loginForm.username.trim() === 'lecturer' && loginForm.password.trim() === 'TdA26!') {
